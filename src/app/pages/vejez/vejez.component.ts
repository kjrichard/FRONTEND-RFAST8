...
@Component({
  ...
  styleUrls: ['./vejez.component.scss']
})
export class VejezComponent implements OnInit {
  ...
  public codigo: number = 1605;
  public edadInicial: number = 60;
  public edadFinal: number = 150;
  public excelData = [];
  public data = [];
  public excel = "";
  public baseUrl: string = "http://127.0.0.1:3000/exportar-excel5/";

...
@Component({
  selector: 'app-adultez',
  templateUrl: './adultez.component.html',
  styleUrls: ['./adultez.component.scss']
})
export class AdultezComponent implements OnInit {
  ...
  public codigo: number = 1604;
  public edadInicial: number = 29;
  public edadFinal: number = 59;
  public excelData = [];
  public data = [];
  public excel = "";
  public baseUrl: string = "http://127.0.0.1:3000/exportar-excel4/";
